Copy konten di bawah ini ke `~/Library/KeyBindings/DefaultKeyBinding.Dict`. Feel free create folders & filesnya kalau belum exists. emang kadang ga exist dan harus dibikin manual.

Setelah itu, untuk apply changesnya, bisa close & reopen aplikasi-aplikasi lainnya (atau restart mac)
...
DNID2997L01:KeyBindings immanueli$ cat ~/Library/KeyBindings/DefaultKeyBinding.Dict 
/* ~/Library/KeyBindings/DefaultKeyBinding.Dict
